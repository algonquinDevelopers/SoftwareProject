        ...
        <div class="col-md-5 nopadding">
            <div class="panel panel-default">
                ...
                <ul class="nav nav-tabs" role="tablist" id="course-tabs">
                  ...
                  <li><a href="#currentPlan" role="tab" data-toggle="tab">Current Plan</a></li>
                   <li><a href="#plan" role="tab" data-toggle="tab">Plans</a></li>
                </ul>
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="currentPlan">
                        <table id="current-plan-table"></table>
                  </div>
