<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){
		...
		if(isset($courseCode) && isset($studentNum)){
			$insertQuery = "INSERT INTO plan (course_no, student_no, plan_version) VALUES ('$courseCode', $studentNum, 1)";
	...
	if($_SERVER['REQUEST_METHOD'] == 'GET'){
		...
		$sql = "SELECT p.student_no, p.course_no, p.plan_version, c.course_name FROM plan p , course c where p.student_no = $studentNum and p.course_no = c.course_no";
